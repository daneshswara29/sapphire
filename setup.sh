...
echo -e "$green.........................................................."$NC
echo -e "$Lyellow                  Autoscript By daneshswara29"$NC
...
VALIDITY() {
    ...
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mCongratulations! You are Allowed to use AUTOSCRIPT daneshswara29..\e[0m"
        sleep 5
    else
...
echo -e "\e[1;32m══════════════════ Autoscript By daneshswara29 ══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|         PREMIUM BY daneshswara29          |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
