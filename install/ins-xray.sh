...
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/daneshswara29/sapphire/main/acme.sh -o /root/.acme.sh/acme.sh
...
#xray-vless-xtls
                ...
                "fallbacks": [
                    ...
                    {
                        "path": "/vless-tls", # // VMESS WS TLS
                        "dest": 1212,
                        "xver": 1
                    },
                    {
                        "path": "/vmess-tls", # // VLESS WS TLS
                        "dest": 1213,
                        "xver": 1
                    },
                    {
                        "path": "/trojan-tls", # // TROJAN WS TLS
                        "dest": 1214,
                        "xver": 1
                    }
                ]
  ...
  "inbounds": [
      ...
      "settings": {
        ...
        "fallbacks": [
          ...
          {
            "path": "/vless-ntls", # // VLESS NONE
            "dest": 1301,
            "xver": 1
          },
          {
            "path": "/vmess-ntls", # // VMESS NONE
            "dest": 1302,
            "xver": 1
          },
          {
             "path": "/trojan-ntls", # // TROJAN NONE
            "dest": 1303,
            "xver": 1
          }
        ]
